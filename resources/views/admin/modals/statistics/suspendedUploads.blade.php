...
<div class="modal fade bottom" id="modal_suspendedUploads" tabindex="-1" role="dialog"
  ...
  <div class="modal-dialog modal-full-height modal-bottom modal-notify modal-danger" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <p class="heading lead">ŠIUO METU SUSPENDUOTI ĮRAŠAI</p>
      ...
      <div style="width:100%; height:40vh; overflow:auto;">
        ...
        <table class="table cursor_pointer">
          ...
          <tbody>
            ...
            @foreach ($inactiveLessons as $lesson)                      
      ...
      <div class="modal-footer">
        <a href="{{route('admin.conmanager')}}" role="button" class="btn btn-danger">PEREITI Į TURINIO VALDYMĄ
          <i class="fa fa-diamond ml-1"></i>
        </a>
        <a role="button" class="btn btn-outline-danger waves-effect" data-dismiss="modal">UŽDARYTI LANGĄ</a>
      </div>
    </div>
    <!--/.Content-->
  </div>
