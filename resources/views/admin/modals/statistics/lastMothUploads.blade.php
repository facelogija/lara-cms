...
<div class="modal fade bottom" id="modal_lastMonthUploads" tabindex="-1" role="dialog"
  ...
  <div class="modal-dialog modal-full-height modal-bottom modal-notify modal-success" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <p class="heading lead">PER PASTARASIAS 30 D. PATALPINTAS TURINYS</p>
      ...
      <div style="width:100%; height:40vh; overflow:auto;">
        ...
        <table class="table cursor_pointer">
          ...
          <tbody>
            @foreach ($upploadsLessonsInMonthGet as $lesson)                       
        ...
        <table class="table cursor_pointer">
          ...
          <tbody>
            @foreach ($upploadsPostsInMonthGet as $post)                       
