<!--Modal: confirm to delete lesson -->
 <div class="modal fade" id="modal_delete_project" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <div class="modal-footer">
            <a href="{{ route('project.delete', $project->id) }}"><button type="button" class="btn btn-danger" >TAIP, IŠTRINTI</button></a>
