...
<div class="modal fade" id="centralModal_search_lesson_by_created_at" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-notify modal-primary" role="document">
    <!--Content-->
    <div class="modal-content">
      <div class="modal-header">
        <p class="heading lead">PAMOKOS PAIEŠKA PAGAL ĮKĖLIMO DATĄ</p>
        ...
        <div class="modal-body">
          <div class="form-group row">
            <div class="col-12">
              ...
              <input class="form-control" type="date" value="2020-12-01" id="date_from" name="date_from">
            </div>
          </div>
          <div class="form-group row">
            <div class="col-12">
              <label>Pasirinkite įkėlimo datą iki</label>
              <input class="form-control" type="date" value="2020-12-01" id="date_to" name="date_to">
            </div>
          </div>
