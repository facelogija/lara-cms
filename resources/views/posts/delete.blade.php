    	...
    	<div class="control_panel_headline">
          ...
          <div class="create_options d-flex">
            <div class="col-sm for_options">
              <a href="/post/{{ $postq->id }}/delete/confirm"><img style="width: 35px; height: 35px;" src="/svg/ok-white.svg" alt="My SVG Icon">Delete</a> 
            </div>
            <div class="col-sm for_options">
              <a href="/admin"><img style="width: 35px; height: 35px;" src="/svg/no-white.svg" alt="My SVG Icon">Return</a> </div>
